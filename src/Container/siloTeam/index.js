...
class Silo extends Component {
  ...
  addActiveClass(ID) {
    ...
    if (this.state.isButtonActive === ID) {
      ...
      this.state.active === true
        ...
        : document
            .getElementById("KnowledgeList")
            .setAttribute("class", "d-block pl-0");
      this.state.active === true
        ? document.getElementById("AddTeamList").setAttribute("class", "d-none")
        : document
            .getElementById("AddTeamList")
            .setAttribute("class", "d-block pl-0");
      this.state.active === true ? this.props.sendData(null) : this.props.sendData(ID);
    } else {
  ...
  silo(ID) {
    ...
    if (this.state.isButtonActive === ID) {
      ...
      document
        .getElementById("KnowledgeList")
        .setAttribute("class", "d-none pl-0");
      document
        .getElementById("AddTeamList")
        .setAttribute("class", "d-none pl-0");
      this.props.sendData(ID);
